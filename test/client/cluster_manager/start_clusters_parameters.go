...
// NewStartClustersParams creates a new StartClustersParams object
// with the default values initialized.
func NewStartClustersParams() *StartClustersParams {
	var ()
	return &StartClustersParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewStartClustersParamsWithTimeout creates a new StartClustersParams object
...
// NewStartClustersParamsWithContext creates a new StartClustersParams object
...
// NewStartClustersParamsWithHTTPClient creates a new StartClustersParams object
...
/*StartClustersParams contains all the parameters to send to the API endpoint
for the start clusters operation typically these are written to a http.Request
*/
