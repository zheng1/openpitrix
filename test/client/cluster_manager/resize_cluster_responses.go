...
func (o *ResizeClusterOK) Error() string {
	return fmt.Sprintf("[POST /v1/clusters/resize][%d] resizeClusterOK  %+v", 200, o.Payload)
}

func (o *ResizeClusterOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.OpenpitrixResizeClusterResponse)
