...
func (o *DescribeRuntimesOK) Error() string {
	return fmt.Sprintf("[GET /v1/runtimes][%d] describeRuntimesOK  %+v", 200, o.Payload)
}

func (o *DescribeRuntimesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
