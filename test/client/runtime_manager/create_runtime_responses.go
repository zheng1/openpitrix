...
func (o *CreateRuntimeOK) Error() string {
	return fmt.Sprintf("[POST /v1/runtimes][%d] createRuntimeOK  %+v", 200, o.Payload)
}

func (o *CreateRuntimeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
