...
When creating charts in memory, use the 'github.com/kubernetes/helm/pkg/proto/hapi/chart'
package directly.
*/
package chartutil // import "github.com/kubernetes/helm/pkg/chartutil"
